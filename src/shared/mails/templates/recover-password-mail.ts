export class RecoverPasswordMail {
  private name: string;
                ...
                <tr>
                  ...
                  >
                    ...
                    >
                      Hola ${this.name},
                      <br /><br />
                      Te saludamos desde el Equipo de ${this.business_name} y te
                      informamos que se ha generado exitosamente una nueva
                    ...
                    >
                      <tr>
                        ...
                        <td style="padding: 5px 0">${this.email}</td>
                      </tr>
                      <tr>
                        <td style="padding: 5px 0">
                          <strong>Contraseña:</strong>
                        </td>
                        <td style="padding: 5px 0">${this.newPassword}</td>
                      </tr>
                    </table>
                    ...
                    >
                      <a
                        href="https://${this.business_domain}.subly.digoai.app"
                        style="
                    ...
                    <p
                      ...
                      "
                    >
                      Si usted no ha solicitado este cambio de contraseña, por
                      favor comuníquese con nosotros a la brevedad posible para
